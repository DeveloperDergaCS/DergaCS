...
CLASS abap_unit_testclass IMPLEMENTATION.
  ...
  METHOD serialize_types.
    ...
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
                `"PACKED":3.141593,"HEX":"AAAAAAAAOt5osQ==","GUID":"","TSL":20151002134450.5545900,"TSL2":20191227160050.4540000,"TS":20160708123456,"DATE":"2016-07-08","TIME":"12:34:56"}` INTO lv_exp.
    lv_act    = /ui2/cl_json=>serialize( data = ls_data ).
    ...
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
                `"PACKED":3.141593,"HEX":"AAAAAAAAOt5osQ==","GUID":"","TSL":"2015-10-02T13:44:50.5545900Z","TSL2":"2019-12-27T16:00:50.4540000Z","TS":"2016-07-08T12:34:56.0000000Z","DATE":"2016-07-08","TIME":"12:34:56"}` INTO lv_exp.
    ...
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"\/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
            `"PACKED":3.141593,"HEX":"AAAAAAAAOt5osQ==","GUID":"","TSL":"2015-10-02T13:44:50.5545900Z","TSL2":"2019-12-27T16:00:50.4540000Z","TS":"2016-07-08T12:34:56.0000000Z","DATE":"2016-07-08","TIME":"12:34:56"}` INTO lv_act.
    ...
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
            `"PACKED":3.141593,"HEX":"AAAAAAAAOt5osQ==","GUID":"","TSL":"2015-10-02T13:44:50.5545900Z","TSL2":"\/Date(1577462450454)\/","TS":"\/Date(1467981296000)\/","DATE":"2016-07-08","TIME":"12:34:56"}` INTO lv_act.
    ...
    " https://blogs.sap.com/2017/01/05/date-and-time-in-sap-gateway-foundation/
    CONCATENATE `{"FLAG":true,"CHAR":"\"TEST\\\"/C:\\temp","NUMC":12345678,"STRING":"ABCDEFG","XSTRING":"q83v","INTEGER":42,"FLOAT":3.1415926535897900E+00,`
            `"PACKED":3.141593,"HEX":"AAAAAAAAOt5osQ==","GUID":"","TSL":"2015-10-02T13:44:50.5545900Z","TSL2":"\/Date(1577462450454)\/","TS":"\/Date(1467981296000)\/","DATE":"2016-07-08","TIME":"PT12H34M56S"}` INTO lv_act.
...
*    cl_aunit_assert=>assert_equals( act = ls_act exp = ls_data msg = 'Deserialization of enumerations fails' ).
  ...
  METHOD deserialize_malformed.
    ...
    CLEAR: user.
    /ui2/cl_json=>deserialize( EXPORTING json = `INVALID_JSON` CHANGING data = user ).
    cl_aunit_assert=>assert_initial( act = user msg = 'Deserialization of invalid JSON fails' ).

    DATA: lr_data TYPE REF TO data.
    lr_data = /ui2/cl_json=>generate( json = `INVALID_JSON` ).
...
*    ).
  ...
  METHOD conversion_exits.
    ...
    lv_json = /ui2/cl_json=>serialize( data = ls_exp ).
    ...
    lv_json = /ui2/cl_json=>serialize( data = ls_exp conversion_exits = abap_true ).

    FIND FIRST OCCURRENCE OF lv_date_x IN lv_json.
    cl_aunit_assert=>assert_subrc( act = sy-subrc msg = 'Conversion exit into external format fails!' ).

    /ui2/cl_json=>deserialize( EXPORTING json = lv_json conversion_exits = abap_true CHANGING data = ls_act ).
    ...
    lv_json = /ui2/cl_json=>serialize( data = lt_act conversion_exits = abap_true ).
  ...
  METHOD generate_special_attr_names.
    ...
    lv_json = `{"system XYZ": {"S/I\D": "XYZ", ":#*~@#$%^&*()_+=><?/": "التجاري"}}`. "#EC NO_TEXT

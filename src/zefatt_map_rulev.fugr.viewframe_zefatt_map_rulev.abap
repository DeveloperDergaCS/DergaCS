*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEFATT_MAP_RULEV
*   generation date: 16.06.2020 at 13:16:35
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEFATT_MAP_RULEV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_RULEV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEFATT_MAP_RULEV_EXTRACT
TOTAL = ZEFATT_MAP_RULEV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_RULEV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEFATT_MAP_RULEV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_MAP_RULEV_EXTRACT
TOTAL = ZEFATT_MAP_RULEV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEFATT_MAP_RULEV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_RULEV'
...
TOTAL = ZEFATT_MAP_RULEV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEFATT_MAP_RULEV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEFATT_MAP_RULEV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_RULEV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEFATT_MAP_RULEV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_MAP_RULEV_EXTRACT
TOTAL = ZEFATT_MAP_RULEV_TOTAL

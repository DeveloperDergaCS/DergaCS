*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEFATT_DIG_SIGNV
*   generation date: 25.06.2020 at 18:03:09 by user DEVELOPER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEFATT_DIG_SIGNV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEFATT_DIG_SIGNV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEFATT_DIG_SIGNV_EXTRACT
TOTAL = ZEFATT_DIG_SIGNV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEFATT_DIG_SIGNV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEFATT_DIG_SIGNV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_DIG_SIGNV_EXTRACT
TOTAL = ZEFATT_DIG_SIGNV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEFATT_DIG_SIGNV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEFATT_DIG_SIGNV'
...
TOTAL = ZEFATT_DIG_SIGNV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEFATT_DIG_SIGNV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEFATT_DIG_SIGNV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEFATT_DIG_SIGNV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEFATT_DIG_SIGNV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_DIG_SIGNV_EXTRACT
TOTAL = ZEFATT_DIG_SIGNV_TOTAL

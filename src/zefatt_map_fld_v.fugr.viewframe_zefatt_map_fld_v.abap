*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEFATT_MAP_FLD_V
*   generation date: 24.11.2020 at 19:25:33 by user MAZZARELLI
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEFATT_MAP_FLD_V    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_FLD_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEFATT_MAP_FLD_V_EXTRACT
TOTAL = ZEFATT_MAP_FLD_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_FLD_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEFATT_MAP_FLD_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_MAP_FLD_V_EXTRACT
TOTAL = ZEFATT_MAP_FLD_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEFATT_MAP_FLD_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_FLD_V'
...
TOTAL = ZEFATT_MAP_FLD_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEFATT_MAP_FLD_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEFATT_MAP_FLD_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEFATT_MAP_FLD_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEFATT_MAP_FLD_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_MAP_FLD_V_EXTRACT
TOTAL = ZEFATT_MAP_FLD_V_TOTAL

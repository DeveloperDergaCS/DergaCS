*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEFATT_CONF_FTPV
*   generation date: 18.06.2020 at 18:57:36 by user DEVELOPER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEFATT_CONF_FTPV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_FTPV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEFATT_CONF_FTPV_EXTRACT
TOTAL = ZEFATT_CONF_FTPV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_FTPV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEFATT_CONF_FTPV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_CONF_FTPV_EXTRACT
TOTAL = ZEFATT_CONF_FTPV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEFATT_CONF_FTPV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_FTPV'
...
TOTAL = ZEFATT_CONF_FTPV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEFATT_CONF_FTPV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEFATT_CONF_FTPV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_FTPV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEFATT_CONF_FTPV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_CONF_FTPV_EXTRACT
TOTAL = ZEFATT_CONF_FTPV_TOTAL

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEFATT_CONF_SOAV
*   generation date: 11.07.2020 at 00:23:11 by user DEVELOPER
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEFATT_CONF_SOAV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_SOAV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEFATT_CONF_SOAV_EXTRACT
TOTAL = ZEFATT_CONF_SOAV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_SOAV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEFATT_CONF_SOAV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_CONF_SOAV_EXTRACT
TOTAL = ZEFATT_CONF_SOAV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEFATT_CONF_SOAV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_SOAV'
...
TOTAL = ZEFATT_CONF_SOAV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEFATT_CONF_SOAV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEFATT_CONF_SOAV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEFATT_CONF_SOAV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEFATT_CONF_SOAV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEFATT_CONF_SOAV_EXTRACT
TOTAL = ZEFATT_CONF_SOAV_TOTAL
